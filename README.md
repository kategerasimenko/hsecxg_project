...
Я выгрузила предсказания логистической регрессии и дерева (вероятности), подобрала порог вероятности, с которого стоит считать ответ единицей (инфинитивом) и посмотрела, каковы результаты.
